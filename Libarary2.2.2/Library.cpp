...
void Book::change() {
	...
	sf::RenderWindow window(sf::VideoMode(500, 600), "ADD Book");
    ...
    sf::RectangleShape Published_btn(sf::Vector2f(200, 70));
    ...
    PublichedContent.setPosition(265, 440);
